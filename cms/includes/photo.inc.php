...
$content_query = 'SELECT id, page, title, type, type_addition, language_file, content FROM '.Database::$db_settings['pages_table'].' WHERE lower(page)=:page AND status!=0 LIMIT 1';
