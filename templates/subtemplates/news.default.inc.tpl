...
<p class="link"><?php if($item['more']): ?><a href="<?php echo BASE_URL.$item['page']; ?>"><?php echo $item['link_name']; ?></a> <?php endif; ?><?php if(isset($item['comments']) && $item['comments']>0): ?><a href="<?php echo BASE_URL.$item['page']; ?>#comments" class="comments">(<?php echo $lang['number_of_comments'][$item['id']]; ?>)</a><?php endif; ?></p>
<?php endif; ?>
</div>
<?php endforeach; ?>
