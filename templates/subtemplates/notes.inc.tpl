...
<h2><?php if($note['link']&&1==2): ?><a href="<?php echo $note['link']; ?>"><?php echo $note['title']; ?></a><?php else: ?><?php echo $note['title']; ?><?php endif; ?></h2>

<?php echo $note['text']; ?>

<?php /* 
if($note['teaser']) : ?><p><?php echo $note['teaser']; ?><br />
<?php if($note['link']): ?><a href="<?php echo $note['link']; ?>"><?php echo $note['linkname']; ?></a><?php endif; ?></p><?php endif; 
*/?>
