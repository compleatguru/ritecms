...
<h1><a href="index.php"><?php echo $lang['administration']; ?></a> &raquo; <a href="index.php?mode=menus"><?php echo $lang['menus']; ?></a> &raquo; <a href="index.php?mode=menus&amp;edit=<?php echo $menu; ?>"><?php echo str_replace('[menu]', $menu, $lang['edit_menu_hl']); ?></a> &raquo; <?php echo $lang['edit_menu_item']; ?></h1>
<?php else: ?>
<h1><a href="index.php"><?php echo $lang['administration']; ?></a> &raquo; <a href="index.php?mode=menus"><?php echo $lang['menus']; ?></a> &raquo; <?php echo str_replace('[menu]', $menu, $lang['edit_menu_hl']); ?></h1>
<?php endif; ?>
  ...
  <table<?php if(!isset($edit_item)): ?> id="sortable"<?php endif; ?> class="admin-table wide" cellspacing="1" cellpadding="5" border="0">
   ...
   <tbody id="items">
    ...
    <tr id="id_<?php echo $item['id']; ?>" class="<?php if($i%2==0): ?>a<?php else: ?>b<?php endif; ?>">
     ...
     <td><a href="index.php?mode=menus&amp;action=edit_menu_item&amp;id=<?php echo $item['id']; ?>"><img src="<?php echo BASE_URL; ?>templates/admin/images/edit.png" alt="<?php echo $lang['edit']; ?>" title="<?php echo $lang['edit']; ?>" width="16" height="16" /></a>&nbsp;&nbsp;<a href="index.php?mode=menus&amp;action=delete_menu_item&amp;id=<?php echo $item['id']; ?>"><img src="<?php echo BASE_URL; ?>templates/admin/images/delete.png" alt="<?php echo $lang['delete']; ?>" title="<?php echo $lang['delete']; ?>" width="16" height="16" /></a>&nbsp;&nbsp;<a href="index.php?mode=menus&amp;move_up=<?php echo $item['id']; ?>"><img src="<?php echo BASE_URL; ?>templates/admin/images/arrow_up.png" alt="<?php echo $lang['move_up']; ?>" title="<?php echo $lang['move_up']; ?>" width="16" height="16" /></a><a href="index.php?mode=menus&amp;move_down=<?php echo $item['id']; ?>"><img src="<?php echo BASE_URL; ?>templates/admin/images/arrow_down.png" alt="<?php echo $lang['move_down']; ?>" title="<?php echo $lang['move_down']; ?>" width="16" height="16" /></a></td>
    </tr>
    <?php ++$i; endforeach; endif; ?>
