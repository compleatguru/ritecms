<h1><a href="index.php"><?php echo $lang['administration']; ?></a> &raquo; <a href="index.php?mode=galleries"><?php echo $lang['photo_galleries']; ?></a> &raquo; <?php echo $lang['new_gallery']; ?></h1>
