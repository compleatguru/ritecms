<h1><a href="index.php"><?php echo $lang['administration']; ?></a> &raquo; <a href="index.php?mode=comments"><?php echo $lang['comments']; ?></a> &raquo; <?php echo $lang['delete_comments']; ?></h1>
