<h1><a href="index.php"><?php echo $lang['administration']; ?></a> &raquo; <a href="index.php?mode=gcb"><?php echo $lang['gcb']; ?></a> &raquo; <?php if(isset($gcb['id'])): echo $lang['edit_gcb']; else: echo $lang['add_gcb']; endif; ?></h1>
