...
<h1><a href="index.php"><?php echo $lang['administration']; ?></a> &raquo; <?php echo str_replace('[page]','<a href="'.BASE_URL.$page_data['page'].'">'.$page_data['page'].'</a>',$lang['edit_page_headline']); ?></h1>
<?php else: ?>
<h1><a href="index.php"><?php echo $lang['administration']; ?></a> &raquo; <?php echo $lang['create_new_page_headline']; ?></h1>
<?php endif; ?>
...
<div id="nav">
 ...
 <p><?php if($wysiwyg_opt): ?><?php if($wysiwyg): ?><a href="index.php?mode=edit<?php if(isset($page_data['id'])): ?>&amp;id=<?php echo $page_data['id']; ?><?php endif; ?>&amp;disable_wysiwyg=true" onclick="return confirm_link('<?php echo rawurlencode($lang['change_edit_mode_notice']); ?>')"><?php echo $lang['edit_non_wysiwyg_mode']; ?></a><?php else: ?><a href="index.php?mode=edit<?php if(isset($page_data['id'])): ?>&amp;id=<?php echo $page_data['id']; ?><?php endif; ?>&amp;enable_wysiwyg=true" onclick="return confirm_link('<?php echo rawurlencode($lang['change_edit_mode_notice']); ?>')"><?php echo $lang['edit_wysiwyg_mode']; ?></a><?php endif; ?><?php else: ?>&nbsp;<?php endif; ?></p>
</div>

<form id="content-form" action="index.php" method="post">
  ...
  <div id="formpart-n1">
   <table cellspacing="0" cellpadding="5" border="0" style="width:100%;">
    ...
    <tr>
     ...
     <div id="wysiwyg"><textarea id="content" name="content" cols="85" rows="28"><?php if(isset($page_data['content'])) echo $page_data['content']; ?></textarea></div>
     </td>
    </tr>
...
<div id="formpart-n3">
  ...
  <div id="formpart-n5">
   <table cellspacing="0" cellpadding="5" border="0">
    ...
    <tr>
     <td><b><?php echo $lang['edit_include_link']; ?></b></td>
     <td><input type="text" name="link_name" value="<?php if(isset($page_data['link_name'])) echo $page_data['link_name']; ?>" size="50" /></td>
     <td>&nbsp;</td>
    </tr>
    <tr>
 ...
 <p><input type="submit" name="edit_submitted" value="<?php echo $lang['edit_page_submit']; ?>" /></p>
</form>
