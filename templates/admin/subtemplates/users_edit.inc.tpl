<h1><a href="index.php"><?php echo $lang['administration']; ?></a><?php if($user_type==1): ?> &raquo; <a href="index.php?mode=users"><?php echo $lang['users']; ?></a><?php endif; ?> &raquo; <?php echo $lang['edit_userdata']; ?></h1></h1>
