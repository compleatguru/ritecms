<h1><a href="index.php"><?php echo $lang['administration']; ?></a> &raquo; <a href="index.php?mode=filemanager"><?php echo $lang['filemanager']; ?></a> &raquo; <?php echo $lang['delete_file']; ?></h1>
