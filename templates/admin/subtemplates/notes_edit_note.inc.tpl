<h1><a href="index.php"><?php echo $lang['administration']; ?></a> &raquo; <a href="index.php?mode=notes"><?php echo $lang['notes']; ?></a> &raquo; <a href="index.php?mode=notes&amp;edit=<?php echo $note['note_section']; ?>"><?php echo $note['note_section']; ?></a> &raquo; <?php if(isset($note['id'])): echo $lang['edit_note']; else: echo $lang['add_note']; endif; ?></h1>
...
-->
   ...
   <tr>
    <td class="edit"><b><?php echo $lang['edit_note_linkname']; ?></b></td>
    <td class="edit"><input type="text" name="linkname" value="<?php if(isset($note['linkname'])) echo $note['linkname']; ?>" size="50" /></td>
   </tr>
   <tr>
